...
greatest of three integer numbers
...
int main(void){
  ...
  printf("\n\n  ::  Your Input numbers is : %d, %d, %d",a,b,c);
   if((a!=b) && (a!=c) && (c!=b)){
     if((a>c) && (a>b)){
       printf("\n\n  :: The gratest of your three numbers is : %d",a);
     }else if((b>a) && (b>c)){
       printf("\n\n  :: The gratest of your three numbers is : %d",b);
   }else if((c>a) && (c>b)){
     printf("\n\n  :: The gratest of your three numbers is : %d\n\n",c);
   }
 }//The End of Testing...
 printf("\n\n            <<<<<<  Good By Sir ! :)  >>>>>>\n\n");
  system("PAUSE\n\n");
